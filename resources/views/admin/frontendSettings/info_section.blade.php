							...
							<form method="post" action="{{route('admin.save.info')}}" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-4">
										...
										<input type="file" required name="box_1_image" accept="image/*" class="form-control">
									...
									<div class="col-md-4">
										...
										<input type="file" required name="box_2_image" accept="image/*" class="form-control">
									...
									<div class="col-md-4">
										...
										<input type="file" required name="box_3_image" accept="image/*" class="form-control">
