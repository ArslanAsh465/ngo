...
@section('content')
    <div class="container py-5">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-8">
                <img src="https://www.almudassar.org/wp-content/uploads/edd/2021/01/14590333_1167252010016094_1413835466111869689_n-770x400.jpg"
                ...
                <p>At Al-Mudassar Trust, we not only provide the children with free education, but we also teach them skills
                    which can help them earn a living in the future. This is a very important part of our mission, and we
                    strongly believe that each child has the ability to reach their potential. We encourage a healthy
                    lifestyle for everyone at our school, and the vegetables grown in our kitchen garden are used in daily
                    cooking. Our in-house carpentry work is usually undertaken by our students, so the children are able to
                    learn multiple and useful talents, as well as being economical for the school.</p>
                <div class="row mb-4">
                    <!-- Image Column -->
                    <div class="col-md-6 text-center mb-4 mb-md-0">
                        <img src="https://www.almudassar.org/wp-content/uploads/edd/2021/01/14600933_1167244833350145_7806809513040772726_n-359x265.jpg"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-4">
                        <h4 class="font-weight-bold mb-4">VOCATIONAL AND TRAINING ACTIVITIES</h4>
                        <p>There are several training activities in Vocational and Training Centre for the students to learn different skills.</p>
                        <ul>
                            <li>Carpentry</li>
                            <li>Fashion</li>
                            <li>Gardening</li>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="text-center">
                            <img src="https://www.almudassar.org/wp-content/uploads/2021/01/IMG_9088-scaled-359x265.jpg" class="img-fluid" alt="IMG_9088" title="IMG_9088">
                        </div>
                    </div>
                </div>
