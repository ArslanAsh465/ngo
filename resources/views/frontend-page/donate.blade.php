...
<div class="container py-5">
    <div class="text-center mb-5">
        ...
        <p class="lead">Your contribution can help transform lives. Support our 500 differently-abled children with your kindness.</p>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-md-12">
            <img src="https://www.almudassar.org/wp-content/uploads/2024/06/web-banner-7-june-png-01-1060x643.png" class="img-fluid rounded" alt="Banner Image">
        </div>
    </div>
