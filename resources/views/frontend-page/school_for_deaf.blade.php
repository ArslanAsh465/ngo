...
@section('title', 'AL-MUDASSAR SCHOOL FOR DEAF')
...
@section('content')
    <div class="container py-5">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-8">
                <img src="https://www.almudassar.org/wp-content/uploads/edd/2021/01/DSC_7587-770x400.jpg"
                    class="img-fluid rounded mb-4" alt="Barnala Branch" style="max-width: 100%; height: auto;">
                <div class="row p-3">
                    <div class="col-md-8">
                        <h2 class="font-weight-bold mb-3">AL-MUDASSAR SCHOOL FOR DEAF</h2>
                    </div>
                    <div class="col-md-4">
                ...
                <p>Less than 5% of 1 million Deaf children in Pakistan have access to education. Even those who enrol for
                    schooling drop out in early stages due to inability to cope with the learning environment. The major
                    problem with deaf children is not lack of hearing but lack of understanding, majority of deaf children
                    born to hearing parents, who generally are not aware how to deal with deafness, on top of that if the
                    deaf child born in the poverty-stricken family then there is little to no hope for any social
                    attachments. AL Mudassar education school supporting the emotional, social and educational needs of deaf
                    children, where children special needs are professionally taking care off, we offer parents counselling
                    sessions for their better understanding and empower deaf children with education to become a valuable
                    member of society instead of depended and victim of society.</p>
                <div class="row mb-4">
                    <!-- Image Column -->
                    <div class="col-md-6 text-center mb-4 mb-md-0">
                        <img src="https://www.almudassar.org/wp-content/uploads/2021/01/DSC_7658-scaled-e1611495848866-735x1024.jpg"
                    ...
                    <div class="col-md-6">
                        ...
                        <ul>
                            ...
                            <li>15 custom-built classrooms from Kindergarten to 12th Class Library</li>
                            <li>Multimedia room</li>
                            <li>Fully equipped IT lab</li>
                            <li>Lego workshop</li>
                            <li>Audiology Laboratory</li>
                            <li>Multipurpose hall</li>
                            <li>Residential facility for faculty and staff</li>
                            <li>Facilities management rooms/security guard rooms</li>
                            <li>Landscaped gardens</li>
                            <li>Lush lawns and fully developed gardens for children</li>
                            <li>Zoo</li>
