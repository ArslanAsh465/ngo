...
@section('title', 'AL-MUDASSAR LEARNING DISABILITY CENTRE')
...
@section('content')
    <div class="container py-5">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-8">
                <img src="https://www.almudassar.org/wp-content/uploads/edd/2021/01/IMG_8754-770x400.jpg"
                    class="img-fluid rounded mb-4" alt="Barnala Branch" style="max-width: 100%; height: auto;">
                <div class="row p-3">
                    <div class="col-md-8">
                        <h2 class="font-weight-bold mb-3">AL-MUDASSAR LEARNING DISABILITY CENTRE</h2>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 text-center mb-4 mb-md-0">
                        <img src="https://www.almudassar.org/wp-content/uploads/edd/2021/01/IMG_9018-scaled-e1611499125154-1024x610.jpg"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ratio ratio-16x9">
                            <iframe
                                src="https://www.youtube.com/embed/m-syV3cN_cQ"
                                frameborder="0"
